...
*/
                ...
                try{
                   ...
                   cert = fsNodeObject.readFileSync("src/balek-server/etc/cert/cert.pem").toString()
                    ...
                    console.log("Could NOT locate user certificates, using autogenerated certificates")
                    key = fsNodeObject.readFileSync("autogenCerts/auto-server.key").toString()
                   cert = fsNodeObject.readFileSync("autogenCerts/auto-ca.crt").toString()
                    console.log(fsNodeObject.readFileSync("autogenCerts/auto-server.key").toString())
                     console.log(fsNodeObject.readFileSync("autogenCerts/auto.csr").toString())
                }
                                    console.log("Using these", key, cert)
