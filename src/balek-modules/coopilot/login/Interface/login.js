define(['dojo/_base/declare',
        ...
        'dojo/text!balek-modules/coopilot/login/resources/html/login.html',
        'dojo/text!balek-modules/coopilot/login/resources/css/login.css'
    ],
    function (declare, lang, topic, domClass, domConstruct, win, on, domAttr, dojoKeys, dijitFocus, dojoReady, InlineEditBox, TextBox, _WidgetBase, _TemplatedMixin, template, templateCSS) {
        ...
        return declare("moduleCoopilotLoginInterface", [_WidgetBase, _TemplatedMixin], {
            _instanceKey: null,
            templateString: template,
            baseClass: "coopilotLoginInterface",
